            ...
            <div class="row more-space">
                ...
                <div class="col-2">
                    <picture>
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/stages/numbers/2dark.svg" class="img-fluid" alt="01">
                    </picture>
                </div>
                <div class="col-9 align-self-center text-justify margin-left-neg-5">
            ...
            <div class="row more-space">
                ...
                <div class="col-2">
                    <picture>
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/stages/numbers/3dark.svg" class="img-fluid" alt="01">
                    </picture>
                </div>
                <div class="col-9 align-self-center text-justify margin-left-neg-5">
            ...
            <div class="row more-space">
                ...
                <div class="col-2">
                    <picture>
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/stages/numbers/4dark.svg" class="img-fluid" alt="01">
                    </picture>
                </div>
                <div class="col-9 align-self-center text-justify margin-left-neg-5">
            ...
            <div class="row more-space">
                ...
                <div class="col-2">
                    <picture>
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/stages/numbers/5dark.svg" class="img-fluid" alt="01">
                    </picture>
                </div>
                <div class="col-9 align-self-center text-justify margin-left-neg-5">
            ...
            <div class="row more-space">
                ...
                <div class="col-2">
                    <picture>
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/stages/numbers/6dark.svg" class="img-fluid" alt="01">
                    </picture>
                </div>
                <div class="col-9 align-self-center text-justify margin-left-neg-5">
