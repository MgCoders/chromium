...
class WPZOOM_Theme_Setup
{
        ...
        $options = array(
            'steps' => array(
                ...
                array(
                    ...
                    'header' => __('Thumbnails Regeneration is Needed', 'wpzoom'),
                    'id' => 'step2',
                    'std' => 'undone',
                    'content' => '<p class="description">'. __('Click on the blue button to start to regenerate the thumbnails for the images that were imported.<br/>By default only <strong>Featured Images</strong> will be regenerated, but you can change that in the <strong>Advanced Settings</strong> below.', 'wpzoom') .'</p>',
                    'controls' => array(
                        array(
                            'action' => 'skip',
                            'class' => 'button-secondary',
                ...
                array(
                    ...
                    'id' => 'step3',
                    'std' => 'undone',
                    'content' => '<p class="description">'. __('Click on the blue button to load the default widget settings (as in theme demo).', 'wpzoom') .'</p>',
                    'controls' => array(
                        array(
                            'action' => 'skip',
                            'class' => 'button-secondary',
    ...
    public function get_front_page_content()
    {
        ...
        $out = '<div class="zoomForms">';
        $out .= '<div class="wpz_option_container clearfix">';
        $out .= '<label for="front-static-pages" class="nofloat">'. __('Configure Homepage', 'wpzoom') .'</label>';

        if ( $front_page_type == 'latest_posts' && ($front_page_option == 'posts' || $front_page_option == 'page') ) {
            $out .= '<p class="description nofloat text-left" style="color: #cc0b0b">'. __('<strong>This theme works best with Latest posts on front page!</strong> If you want to use custom page template for front page, select <strong>A static page</strong> option below and then select the <strong>"Homepage"</strong> and <strong>"Blog"</strong> pages from the lists below.', 'wpzoom') .'</p>';
        }
        ...
        if ( $front_page_type == 'static_page' && $front_page_option == 'page' ) {
            $out .= '<p class="description nofloat text-left" style="color: #cc0b0b">'. __('We recommend you to select <strong>A static page</strong> option below and then select the <strong>"Homepage"</strong> and <strong>"Blog"</strong> pages from the lists below.', 'wpzoom') .'</p>';
        }
        ...
        $out .= '<p class="description nofloat text-left">'. sprintf(__('You can also configure your front page and posts page later from %sReading Settings%s', 'wpzoom'), '<a href="'. admin_url('options-reading.php') .'" target="_blank" title="'. __('Open Reading settings page', 'wpzoom') .'">', '</a>') .'</p>';
