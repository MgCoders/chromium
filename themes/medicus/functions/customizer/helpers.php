...
function medicus_sanitize_choice( $value, $setting ) {
    return $value;
}
 ...
 */
function medicus_sanitize_text( $string ) {
    global $allowedtags;
     ...
     */
    apply_filters( 'medicus_sanitize_text_allowed_tags', $expandedtags, $string );
