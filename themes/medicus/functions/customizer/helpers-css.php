...
if ( ! class_exists( 'medicus_CSS' ) ) :
    ...
    class medicus_CSS {
        ...
        /**
         * The one instance of medicus_CSS.
         *
         * @var   medicus_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one medicus_CSS instance.
         *
         * @return medicus_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'medicus_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `medicus_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'medicus_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'medicus_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'medicus_get_css' ) ) :
    /**
     * Return the one medicus_CSS object.
     *
     * @return medicus_CSS    The one medicus_CSS object.
     */
    function medicus_get_css() {
        return medicus_CSS::instance();
    }
endif;

add_action( 'init', 'medicus_get_css', 1 );